...
try:
    ...
    _pre_logger = logging.getLogger("services.clustering")
...
#
# ARCH-5 TODO: remplacer par un champ du RunContext ou PipelineResult pour
# éliminer cet état global. Voir gate_result.py même problématique.
_HARMONY_DIAG: Dict[str, Any] = {}  # {"plotly": Figure | None, "mpl": Figure | None}
