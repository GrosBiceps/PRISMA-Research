...
class TestPopulationTreeController:
    def test_build_panel_widget(self, qapp):
        from src.gui.viewer.population_tree_controller import PopulationTreeController
...
class TestWorksheetLayout:
    def test_validate_column_count_valid(self):
        from src.gui.viewer.worksheet_layout import validate_column_count

        for n in [1, 2, 3, 4]:
            assert validate_column_count(n) == n

    def test_validate_column_count_invalid(self):
        from src.gui.viewer.worksheet_layout import validate_column_count, WorksheetLayoutError
    ...
    def test_save_and_load_layout(self, tmp_path):
        from src.gui.viewer.worksheet_layout import (
    ...
    def test_load_missing_file_returns_default(self, tmp_path):
        from src.gui.viewer.worksheet_layout import load_layout_state
    ...
    def test_load_invalid_column_count_fallback(self, tmp_path):
        from src.gui.viewer.worksheet_layout import load_layout_state, _FORMAT_VERSION
...
class TestWorksheetAreaColumns:
    def test_set_panel_columns_valid(self, qapp):
        from src.gui.viewer.gating_workspace import WorksheetArea
    ...
    def test_set_panel_columns_invalid(self, qapp):
        from src.gui.viewer.gating_workspace import WorksheetArea
        from src.gui.viewer.worksheet_layout import WorksheetLayoutError
